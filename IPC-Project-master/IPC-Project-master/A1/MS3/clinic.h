...
// Todo:
void addAppointment(struct Appointment* app, int maxPatient, struct Patient* pt, int maxAppointment);

// Remove an appointment record from the appointment array
// Todo:
void removeAppointment(struct Appointment* app, int maxPatient, struct Patient* pt, int maxAppointment);
